    ...
    with open(log_file_path, 'r') as file:
        for line in file:
            ...
            if 'Input Orientation Information:' in line:
                ...
                if coordinates:
                    coordinates_list.append((file_info, coordinates))
                    coordinates = []
                continue
...
def convert_cartesian_to_internal(all_cartesian_coords):
    ...
    for file_info, cartesian_coords in all_cartesian_coords:
        ...
        all_internal_coords.append((file_info, internal_coords))
    
    return all_internal_coords

def write_internal_coordinates(all_internal_coords, output_file):
    with open(output_file, 'w') as file:
        for file_info, internal_coords in all_internal_coords:
